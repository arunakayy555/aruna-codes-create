    ...
    <section id="about" className="py-32 px-6 md:px-8">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-8 max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-foreground/90 leading-loose tracking-wide">
            I enjoy challenges that blend logic, creativity, and tangible impact. From writing efficient algorithms to designing intuitive user experiences, I'm drawn to challenges that require both technical rigor and thoughtful design!
          </p>
